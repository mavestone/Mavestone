...
export function AiInput({ onSend }: { onSend?: (value: string) => void }) {
  ...
  return (
    <div className="w-full py-4">
      <div className="relative max-w-xl border rounded-[22px] border-white/5 p-1 w-full mx-auto bg-white/5 backdrop-blur-sm">
        <div className="relative rounded-2xl border border-white/5 bg-neutral-800/5 flex flex-col">
          <div
          ...
          >
            <div className="relative">
              <Textarea
                ...
                value={value}
                placeholder=""
                className="w-full rounded-2xl rounded-b-none px-4 py-3 bg-transparent border-none text-white resize-none focus-visible:ring-0 leading-[1.2]"
                ref={textareaRef}
                onKeyDown={(e) => {
          ...
          <div className="h-12 bg-white/5 rounded-b-xl">
            <div className="absolute left-3 bottom-3 flex items-center gap-2">
              <label
                className={cn(
                  "cursor-pointer relative rounded-full p-2 bg-white/5",
                  imagePreview
              ...
              >
                ...
                <Paperclip
                  className={cn(
                    "w-4 h-4 text-white/40 hover:text-white transition-colors",
